...
class epibert_rampage_finetune(tf.keras.Model):
    def __init__(self,
                 ...
                 num_heads:int = 8,
                 numerical_stabilizer: float =0.0000001,
                 ...
                 name: str = 'epibert_rampage_finetune',
        ...
        super(epibert_rampage_finetune, self).__init__(name=name,**kwargs)
